...
class seo {
  ...
  public function albumSongSeo( $alTitle ) {
    $this->alTitle = $alTitle;
    $this->alSongTitle = $_GET['song'];
...
<script type="text/javascript">
  var baseUrl="<?php echo BASE_URL ?>"; var imgUrl="http://img.wtsongs.com"; var cdnUrl="http://cdn.wtsongs.com"; var GlobalLangArr="Hindi,English,Tamil,Bengali,Bhojpuri,Telugu,Punjabi,Others";var phpCurUrl="<?php echo $this->curUrl; ?>";
...
<meta name="description" content="Download and Listen Free Music including Hindi, Bollywood, English, Bhojuri, Tamil, Telugu Albums Playlist at wtsongs.com" />';
  ...
  public function displayKeyword() {
    echo '
<meta name="keywords" content="free mp3 song, mp3 albums, free download, full album download, online play music, hindi albums, bollywood albums, english music, bhojpuri mp3 song, tamil mp3 song, telugu song, maithili song, top playlists, artist mp3 song, actor song, actress song, top song category" />';
  }
